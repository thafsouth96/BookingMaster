...
<div id="menuG">
  ...
  <a href="#">Déconnexion</a>
    ...
    <div id="formulaire">
      ...
      <form id="contact" action="../Controller/traitement.ctrl.php" method="post"> <!--a dvp-->

      		<p><label for="email"></label><input type="email" id="email" name="email" value="A" /></p>
      		<p><label for="cc"></label><input type="text" id="cc" name="cc" value="CC" /></p>

      		<p><label for="objet"></label><input type="text" id="objet" name="objet" value="Objet" /></p>
